...
/**
 * Default implementation of {@link TableRendererEngineInterface}.
 *
 * @author Bernhard Schussek <bschussek@gmail.com>
 */
abstract class AbstractRendererEngine implements TableRendererEngineInterface
{
    /**
     * The variable in {@link TableView} used as cache key.
     */
     ...
     * {@inheritdoc}
     */
    public function getResourceForBlockName(TableView $view, $blockName)
    {
        $cacheKey = $view->vars[self::CACHE_KEY_VAR];
     ...
     * {@inheritdoc}
     */
    public function getResourceForBlockNameHierarchy(TableView $view, array $blockNameHierarchy, $hierarchyLevel)
    {
        $cacheKey = $view->vars[self::CACHE_KEY_VAR];
     ...
     * {@inheritdoc}
     */
    public function getResourceHierarchyLevel(TableView $view, array $blockNameHierarchy, $hierarchyLevel)
    {
        $cacheKey = $view->vars[self::CACHE_KEY_VAR];
        $blockName = $blockNameHierarchy[$hierarchyLevel];
     ...
     *
     * @param string   $cacheKey  The cache key of the table view.
     * @param TableView $view      The table view for finding the applying themes.
     * @param string   $blockName The name of the block to load.
     *
     * @return bool    True if the resource could be loaded, false otherwise.
     */
    abstract protected function loadResourceForBlockName($cacheKey, TableView $view, $blockName);
     ...
     *                                     resource.
     * @param TableView $view               The table view for finding the applying
     *                                     themes.
     ...
     * @return bool    True if the resource could be loaded, false otherwise.
     */
    private function loadResourceForBlockNameHierarchy($cacheKey, TableView $view, array $blockNameHierarchy, $hierarchyLevel)
    {
        $blockName = $blockNameHierarchy[$hierarchyLevel];
